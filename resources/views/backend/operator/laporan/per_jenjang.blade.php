...
@section('content')
    ...
    <form action="{{ route('operator.laporan.cari_jenjang') }}" method="POST">
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body table-responsive">
                        ...
                        <div class="form-group col-md-12">
                            <label for="exampleInputEmail1">Pilih Jenjang</label>
                            ...
                            @if ($errors->has('jenjang'))
                                <small class="form-text text-danger">{{ $errors->first('jenjang') }}</small>
                            @endif
                        </div>
